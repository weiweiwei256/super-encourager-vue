<template>
    <div id='root'
        ...
        <el-dialog title="简历心得"
            ...
            <p>• 公共信息展示: 博客浏览量（csdn广告太多不推荐，掘金曝光高于简书）、开源项目、github、star数量等、对于公共资源的深入理解和改进。提供公共链接或二维码</p>
            <p>• 个人技能:</p>
            <p>○ 注意分类：要把相同类型的技术集中分类，切忌胡乱堆砌。 例如：要把git和svn放一类，这是基本专业性的体现。</p>
            <p>○ 描述：我的个人习惯如下</p>
            <p>§ 了解：自己没有实践，但是了解过定位和价值等信息</p>
            <p>§ 熟悉：自己实际使用过，有项目体现，但未深入底层源码或者深入研究原理</p>
            <p>§ 精通：自己深层次使用过，跟过底层代码，并可以独立解决疑难问题（精通要求很高，很可能会被追问，客观实际一点）</p>
            <p>• 项目经历：</p>
            <p>○ 建议先将项目定位和价值说明清楚，可以与自己的定位和价值分开说明。最重要的是要有结果说明。例如多少人使用，成功交付，对公司的价值等等。如果是负责架构方面的工作，尽量上个架构图，绝对的亮点。</p>
